...
For these Terms, "Application" means the published npm package `@vacbo/oh-my-opencode`, its installed `oh-my-opencode` CLI binary, and the plugin runtime it installs. "Service" means the Application and related project distribution surfaces. "We" and "our" refer to the maintainer of oh-my-opencode. "You" refer to the individual or entity using the Service.
